...
@Data
public class ImportItemsTemplate1 extends BaseEntity
{
    ...
    @Excel(name = "欧盟国家", sort = 6, headerBackgroundColor = IndexedColors.DARK_BLUE)
    @Size(max = 2, message = "长度不能超过2个字符")
    private String codigoPais;

    /** 位置 78-92 ：经营者 欧盟税号-编号 */
    @Excel(name = "欧盟税号", sort = 7, headerBackgroundColor = IndexedColors.DARK_BLUE)
    @Size(max = 15, message = "长度不能超过15个字符")
    private String nifOperador;

    /** 位置 93-132 ：经营者姓名或公司名称 */
    @Excel(name = "公司名称", sort = 8, headerBackgroundColor = IndexedColors.DARK_BLUE)
    @Size(max = 40, message = "长度不能超过40个字符")
    private String nombreOperador;

    /** 位置 133 ： 操作代码 */
    @Excel(name = "销售/购买", sort = 9, headerBackgroundColor = IndexedColors.DARK_BLUE)
